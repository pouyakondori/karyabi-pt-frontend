    ...
    <div className="space-y-8">
      <section className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 px-6 py-10 text-white shadow-xl sm:px-10">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-sm leading-8 text-slate-200 sm:text-base">
              {t('login.description')}
            </p>
          </div>
      ...
      <section className="grid gap-5 lg:grid-cols-3">
        {options.map(option => {
          ...
          const buttonLabel = option.disabled
            ? option.disabledLabel ?? t('login.loginAction')
            : t('login.loginAction')
          ...
          return (
            ...
            >
              <div
                className={`absolute inset-x-0 top-0 h-28 bg-gradient-to-br ${option.accentClassName}`}
              />
