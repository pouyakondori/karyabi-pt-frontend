    ...
    <div className="mx-auto max-w-5xl space-y-6">
      <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 p-8 text-white shadow-sm">
        <div className="space-y-4">
          ...
          <h1 className="text-3xl font-black leading-tight sm:text-4xl">{t("employer.createPageHeroTitle")}</h1>
          <p className="max-w-3xl text-sm leading-8 text-slate-200 sm:text-base">{t("employer.createPageHeroDescription")}</p>
        </div>
      </section>
