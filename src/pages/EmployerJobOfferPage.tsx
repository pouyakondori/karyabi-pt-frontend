  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-2xl bg-amber-50 p-4">
              ...
              <div className="mt-1 font-bold text-amber-900">
                {job._count?.applications ?? candidates.length}
              </div>
            </div>
          </div>
          ...
          <div>
            <h2 className="text-lg font-bold text-slate-900">
              {t('employer.jobDescriptionTitle')}
            </h2>
      ...
      <SectionCard title={t('employer.candidatesTitle')}>
        {candidates.length === 0 ? (
          <div className="text-sm text-slate-500">{t('employer.emptyCandidates')}</div>
        ) : null}
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  <div className="font-semibold text-slate-900">
                    {candidate.seeker.seekerProfile?.fullName ?? candidate.seeker.email}
                  </div>
                  ...
                  <div className="mt-1 text-sm text-slate-600">
                    {t('labels.appliedAt')}:{' '}
                    {new Date(candidate.appliedAt).toLocaleDateString('fa-IR')}
                  </div>
                </div>
